...
# AJUSTES TRAGAPERRAS
# Imagenes
fondo = "Imagenes/FONDO/R.jpg"  # Define la ruta de la imagen de fondo del juego.
camino_simbolos = "Imagenes/Simbolos"  # Define la ruta de las imágenes de los símbolos del juego.
...
ui_fuente = "Fuente/Nightmare Codehack.otf"  # Define la fuente del texto del juego.
