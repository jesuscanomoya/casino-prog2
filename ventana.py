...
class MainApp(QMainWindow):
    def __init__(self,titulo, parent=None, *args):  # Inicializamos los parámetros
        ...
        if self.titulo == "Registro de usuario":
            ...
            self.apellido_label.setGeometry(280, 350, 231, 41)
            ...
            self.line_password.setGeometry(280, 600, 231, 30)

            self.enter_button.setGeometry(360, 650, 93, 28)
            self.no_accounts_button.setGeometry(350, 700, 110, 28)
