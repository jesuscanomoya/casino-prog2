...
from jugador2 import Jugador  # Importa la clase 'Jugador' del módulo 'jugador'.
from carretes2 import *  # Importa todas las variables y funciones del módulo 'carretes'.
from ajustes import *  # Importa todas las variables y funciones del módulo 'ajustes'.
from wins2 import *  # Importa todas las variables y funciones del módulo 'wins'.
from ui2 import UI  # Importa la clase 'UI' del módulo 'ui'.
...
class Maquina:  # Define una clase llamada 'Maquina'.
    ...
    def __init__(self,jugador):  # Define el método inicializador de la clase.
        ...
        # importar sonidos
        self.sonido_giro = pygame.mixer.Sound("Tragaperras/giro.mp3")
        self.sonido_giro.set_volume(0.05)
        self.sonido_fila_3 = pygame.mixer.Sound("Tragaperras/win_3.mp3")
        self.sonido_fila_3.set_volume(0.9)
        self.sonido_fila_4 = pygame.mixer.Sound("Tragaperras/win_4.mp3")
        self.sonido_fila_4.set_volume(0.9)
        self.sonido_fila_5 = pygame.mixer.Sound("Tragaperras/win_5.mp3")
